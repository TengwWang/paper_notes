...
Figure-first scientific paper notes hosted with GitHub Pages.
...
- `index.html`: searchable paper-library homepage
- `papers.json`: paper registry / lightweight database
